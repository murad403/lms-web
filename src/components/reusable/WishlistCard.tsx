  ...
  return (
    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 py-4 border-b border-gray-100 last:border-b-0">
      ...
      <div className="flex items-start gap-3 flex-1 min-w-0">
        <div className="relative w-20 h-14 sm:w-24 sm:h-16 rounded-md overflow-hidden shrink-0">
          <Image
            src={course.image}
            alt={course.title}
            fill
      ...
      <div className="flex items-center gap-2 shrink-0">
        <Link
          ...
          className="px-4 py-2 border border-gray-300 rounded text-xs sm:text-sm font-medium text-title hover:bg-gray-50 transition-colors whitespace-nowrap"
        >
          Buy Now
        </Link>
        <button className="px-4 py-2 bg-main text-white rounded text-xs sm:text-sm font-medium hover:bg-main/90 transition-colors whitespace-nowrap">
          Add To Cart
        </button>
        <button className="p-2 text-main hover:bg-blue-50 rounded transition-colors">
