      ...
      <header className="bg-white border-b border-gray-200 sticky top-0 z-30 lg:ml-60">
        <div className="flex items-center justify-between px-4 sm:px-6 py-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs text-green-600 font-medium">Good Morning</p>
              <h1 className="text-lg font-bold text-title">{getPageTitle()}</h1>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            {/* Profile */}
            <Link href="/instructor/settings" className="w-9 h-9 rounded-full overflow-hidden border-2 border-gray-200 hover:border-main transition-colors">
              <Image src={user} alt="User" width={36} height={36} className="w-full h-full object-cover" />
            </Link>
          </div>
        </div>
