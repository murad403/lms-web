    ...
    return (
        <div className="w-full lg:w-1/2 flex flex-col justify-center items-center py-10 md:py-0">
            <div className="w-full px-6 md:px-8 lg:px-12 xl:px-16 max-w-xl">
                ...
                <h1 className="text-3xl font-bold text-header mb-2">{t('organizationRegistrationTitle')}</h1>
                <p className="text-description mb-6">{t('registrationSubtitle')}</p>

                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 w-full">
                    {/* Contact Person Name */}
                    <div>
                        <label className="block text-sm font-semibold text-header mb-2">{t('contactPersonName')}</label>
                    ...
                    {/* Organization Name */}
                    <div>
                        <label className="block text-sm font-semibold text-header mb-2">{t('organizationName')}</label>
                        <div className="relative">
