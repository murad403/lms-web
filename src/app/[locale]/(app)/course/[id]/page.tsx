        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-0 mt-4 sm:mt-6 lg:mt-8">
            <div className="flex flex-col lg:flex-row gap-4 sm:gap-6">
                ...
                <div className="flex-1">
                        ...
                        <div className="border border-gray-200 rounded-lg p-4 sm:p-5 bg-white">
                            ...
                            <div className="space-y-2 sm:space-y-3 pt-3 sm:pt-4 border-t">
                                ...
                                <div className="flex items-center gap-2 sm:gap-3">
                                    ...
                                    <div>
                                        <p className="text-[10px] sm:text-xs text-description">{t("subtitle")}</p>
                    ...
                    {/* Details */}
                    <div className="mb-6 sm:mb-8">
                        <h2 className="text-xl sm:text-2xl font-bold text-header mb-3 sm:mb-4">{t("details")}</h2>
                        <p className="text-xs sm:text-sm text-description leading-relaxed">{courseData.details}</p>
                    </div>

                    {/* Effectiveness */}
                    <div className="mb-6 sm:mb-8">
                        <h2 className="text-xl sm:text-2xl font-bold text-header mb-3 sm:mb-4">{t("effectiveness")}</h2>
                        <p className="text-xs sm:text-sm text-description leading-relaxed">{courseData.effectiveness}</p>
                    </div>

                    {/* Who This Course is For */}
                    <div className="mb-6">
                        <h2 className="text-xl sm:text-2xl font-bold text-header mb-3 sm:mb-4">{t("whoThisCourseIsFor")}</h2>
                        <ul className="space-y-1.5 sm:space-y-2">
