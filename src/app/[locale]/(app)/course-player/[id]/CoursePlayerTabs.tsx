                ...
                {activeReply === comment.id && (
                    <div className="mt-3">
                        <div className="flex items-center gap-2 sm:gap-3">
                            ...
                            <button className="px-4 py-2.5 bg-main text-white text-sm font-semibold hover:bg-main/90 transition-colors whitespace-nowrap">
                                {t("commentReply")}
                            </button>
                        </div>
                    </div>
            ...
            <div className="mb-4 sm:mb-6">
                ...
                <div className="flex flex-wrap items-center justify-between gap-3 sm:gap-4 mt-3">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <div className="text-xs sm:text-sm text-description ">
                            <span className="font-semibold text-title">
                                {coursePlayerInfo.studentsWatching}
                            </span>{" "}
                            <p>{t("studentsWatching")}</p>
                        </div>
                    </div>
                ...
                {activeTab === "notes" && (
                    <div>
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <button onClick={handleDownloadNotes} className="flex items-center gap-2 px-4 py-3 bg-[#EDF5FD] text-[#4F9BEF] text-sm font-semibold hover:bg-[#EDF5FD]/90 transition-colors">
                    ...
                    <div>
                        ...
                        <div className="space-y-3">
                            {courseAttachments.map((file) => (
                                <div
                                    key={file.id}
                                    className="flex items-center justify-between px-4 py-5 transition-colors bg-[#F5F7FA]"
                                >
                ...
                {activeTab === "comments" && (
                    <div>
                        ...
                        <div className="flex items-center gap-2 sm:gap-3 mb-6">
                            ...
                            <button className="px-4 sm:px-6 py-2.5 bg-main text-white text-xs sm:text-sm font-semibold hover:bg-main/90 transition-colors">
                                {t("comment")}
                            </button>
                        </div>
