    ...
    return (
        <div className="relative w-full h-60 sm:h-80 md:h-96 lg:h-100 overflow-hidden">
            ...
            <div className="relative z-10 container mx-auto flex flex-col justify-center h-full px-4 md:px-5 lg:px-6 xl:px-0 2xl:px-0">
                <h1 className="text-4xl lg:text-5xl font-bold text-navy-blue leading-tight ">
                    {t("bannerTitle")}
                </h1>
                ...
                <div className=" mt-4 flex items-center">
                    <SignUpGuardLink href={"/auth/trainer-sign-up"} className="md:py-4 py-3 px-6 border-2 text-sm font-medium text-white bg-main hover:bg-main/90 transition-colors cursor-pointer">
                        {t("startTeaching")}
                    </SignUpGuardLink>
                </div>
