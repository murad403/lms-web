                ...
                {paymentCards[cardView] && (
                    <div className="bg-linear-to-br from-[#1B2E5A] to-[#0F1B35] p-5 text-white mb-4 relative">
                        ...
                        <div className="flex justify-between text-sm">
                            <div>
                                <p className="text-base text-gray-300 uppercase">Expires</p>
                                <p className='text-base font-semibold'>{paymentCards[cardView].expiry}</p>
                            </div>
                            <div>
                                <p className="text-base text-gray-300 uppercase">Card Holder</p>
                    ...
                    <form onSubmit={handleSubmit(onAddCard)} className="space-y-4 mt-2">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input {...register("cvc")} placeholder="Security Code" className="w-full px-3 py-2.5 border border-gray-300 text-sm focus:outline-none focus:border-main" />
                            </div>
                        </div>
