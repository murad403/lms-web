                    ...
                    <aside className="w-90 shrink-0 hidden lg:block">
                        <div>
                            <div className="flex items-center justify-between mb-4">
                                <h3 className="text-sm font-bold text-header uppercase tracking-wide">Filters</h3>
                                <button
                                    type="button"
                ...
                <div className="flex-1 min-w-0">
                    ...
                    {paginatedCourses.length === 0 && (
                        <div className="flex flex-col items-center justify-center py-20 text-center">
                            <p className="text-lg font-semibold text-header mb-2">No courses found</p>
                ...
                <div className="fixed inset-0 z-50 lg:hidden">
                    ...
                    <div className="absolute left-0 top-0 h-full w-full max-w-sm bg-white shadow-xl overflow-y-auto">
                        <div className="sticky top-0 bg-white border-b border-gray-200 px-5 py-4 flex items-center justify-between">
                            <h3 className="text-lg font-bold text-header">Filters</h3>
                            <button
                                type="button"
