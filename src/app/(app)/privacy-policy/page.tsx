        ...
        <div>
            ...
            <section className="pt-16 container mx-auto">
                <div className="max-w-5xl mx-auto space-y-8">
                    ...
                    <div>
                        <h2 className="text-2xl font-bold text-header mb-4">2. Information We Collect</h2>
                        ...
                        <div className="ml-6 space-y-3">
                            <div>
                                <p className="text-title text-lg font-semibold mb-1">Personal Data:</p>
                            ...
                            <div>
                                <p className="text-title text-lg font-semibold mb-1">Usage Data:</p>
                                <ul className="list-disc ml-6 space-y-1 text-description text-[16px]">
                    ...
                    <div>
                        <h2 className="text-2xl font-bold text-header mb-4">3. How We Use Your Information</h2>
                        <p className="text-description text-[16px] leading-relaxed mb-3">We use the information we collect to:</p>
                    ...
                    {/* 4. GDPR Compliance */}
                    <div>
                        <h2 className="text-2xl font-bold text-header mb-4">4. GDPR Compliance</h2>
                        <p className="text-description text-[16px] leading-relaxed mb-3">
                    ...
                    <div>
                        <h2 className="text-2xl font-bold text-header mb-4">5. Data Sharing and Disclosure</h2>
                        <p className="text-description text-[16px] leading-relaxed mb-3">
                    ...
                    {/* 6. Data Security */}
                    <div>
                        <h2 className="text-2xl font-bold text-header mb-4">6. Data Security</h2>
                    ...
                    {/* 7. Data Retention */}
                    <div>
                        <h2 className="text-2xl font-bold text-header mb-4">7. Data Retention</h2>
                        <p className="text-description text-[16px] leading-relaxed">
                    ...
                    <div>
                        <h2 className="text-2xl font-bold text-header mb-4">8. Your Rights and Choices</h2>
                        <p className="text-description text-[16px] leading-relaxed">
                    ...
                    <div>
                        <h2 className="text-2xl font-bold text-header mb-4">9. Children&apos;s Privacy</h2>
                        <p className="text-description text-[16px] leading-relaxed">
                    ...
                    <div>
                        <h2 className="text-2xl font-bold text-header mb-4">10. Changes to This Policy</h2>
                        <p className="text-description leading-relaxed">
                    ...
                    {/* 11. Contact Us */}
                    <div>
                        <h2 className="text-2xl font-bold text-header mb-4">11. Contact Us</h2>
