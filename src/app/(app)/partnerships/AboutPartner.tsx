                    ...
                    <div>
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center gap-3">
                                ...
                                <span className="text-description text-xs sm:text-sm md:text-base">Operate with a recognized and qualified role in your territory</span>
                            </div>
                            <div className="flex items-center gap-3">
                                <Check className="text-green-500 w-5 h-5 shrink-0" />
                                <span className="text-description text-xs sm:text-sm md:text-base">Collaborate with accredited schools, institutions, and trainers</span>
                            </div>
                            <div className="flex items-center gap-3">
                                <Check className="text-green-500 w-5 h-5 shrink-0" />
                            ...
                            <div className="flex items-center gap-3">
                                <Check className="text-green-500 w-5 h-5 shrink-0" />
                                <span className="text-description text-xs sm:text-sm md:text-base">Promote a ready-to-use, certified, and constantly updated course catalo</span>
                            </div>
                            <div className="flex items-center gap-3">
                                <Check className="text-green-500 w-5 h-5 shrink-0" />
                                <span className="text-description text-xs sm:text-sm md:text-base">Earn commissions on every course sold through your code</span>
                            </div>
                            <div className="flex items-center gap-3">
                                <Check className="text-green-500 w-5 h-5 shrink-0" />
                                <span className="text-description text-xs sm:text-sm md:text-base">Increase visibility, authority, and professional opportunities</span>
                            </div>
                        </div>
                    </div>
