...
const CookiePolicyPage = () => {
    return (
        <div>
            <FooterNavigationBanner title="Cookie Policy" description="Last updated: January 27, 2025" />

            <section className="pt-16 container mx-auto">
                <div className="max-w-5xl mx-auto space-y-8">
                    {/* 1. Introduction */}
                    <div>
                        <h2 className="text-2xl font-bold text-header mb-4">1. Introduction</h2>
                    ...
                    {/* 2. What Are Cookies? */}
                    <div>
                        <h2 className="text-2xl font-bold text-header mb-4">2. What Are Cookies?</h2>
                        <div className="ml-6 space-y-2">
                            <p className="text-description text-[16px]">
                                <span className="font-semibold">We utilize the following types of cookies:</span>
                            </p>
                            <ul className="list-disc ml-6 space-y-1 text-description text-[16px]">
                    ...
                    <div>
                        <h2 className="text-2xl font-bold text-header mb-4">3. How We Use Cookies</h2>
                        <p className="text-description leading-relaxed mb-3">We use cookies to:</p>
                        <ul className="list-disc ml-6 space-y-2 text-description text-[16px]">
                    ...
                    <div>
                        <h2 className="text-2xl font-bold text-header mb-4">4. Analyze site traffic and user behavior</h2>
                        <p className="text-description text-lg leading-relaxed mb-3">
                    ...
                    <div>
                        ...
                        <div className="ml-6 space-y-1 text-description text-[16px]">
                            <p>
                    ...
                    <div>
                        <h2 className="text-2xl font-bold text-header mb-4">6. Data Sharing and Disclosure</h2>
                        <p className="text-description text-lg leading-relaxed mb-3">
                    ...
                    {/* 7. Data Security */}
                    <div>
                        <h2 className="text-2xl font-bold text-header mb-4">7. Data Security</h2>
                    ...
                    {/* 8. Data Retention */}
                    <div>
                        <h2 className="text-2xl font-bold text-header mb-4">8. Data Retention</h2>
                        <p className="text-description text-lg leading-relaxed">
                    ...
                    <div>
                        <h2 className="text-2xl font-bold text-header mb-4">9. Your Rights and Choices</h2>
                        <p className="text-description text-lg leading-relaxed mb-3">
                    ...
                    <div>
                        <h2 className="text-2xl font-bold text-header mb-4">10. Children&apos;s Privacy</h2>
                        <p className="text-description text-lg leading-relaxed">
                    ...
                    <div>
                        <h2 className="text-2xl font-bold text-header mb-4">11. Changes to This Policy</h2>
                        <p className="text-description text-lg leading-relaxed">
                    ...
                    {/* 12. Contact Us */}
                    <div>
                        <h2 className="text-2xl font-bold text-header mb-4">12. Contact Us</h2>
                        <p className="text-description leading-relaxed mb-3">
                            If you have questions about this Privacy Policy, please contact us:
                        </p>
                        <div className="ml-6 space-y-1 text-description text-sm">
                            <p>
                                <span className="font-semibold">Email:</span> privacy@form-cert.eu
                            </p>
                            <p>
