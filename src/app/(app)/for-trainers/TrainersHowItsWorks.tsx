                            ...
                            <div className="flex flex-col gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600 leading-relaxed">
                                        Create your account in just a few minutes by entering your credentials. Simple and free registration
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="flex flex-col gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600 leading-relaxed mb-2">
                                        Upload your lessons, teaching materials, and structure your course program. — Videos, Slides, Documents, Assessment tests.
                                    </p>
                                    <p className="text-gray-600 leading-relaxed">
                        ...
                        <div className="border border-gray-100 rounded-md p-5 md:p-6 shadow-sm">
                            <div className="flex flex-col gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600 leading-relaxed mb-2">
                                        Our team reviews your content and, if compliant, certifies it according to the required standards.
                                    </p>
                                    <p className="text-gray-600 leading-relaxed">
                        ...
                        <div className="border border-gray-100 rounded-md p-5 md:p-6 shadow-sm">
                            <div className="flex flex-col gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600 leading-relaxed mb-2">
                                        Your course is sold online and you start earning.
                                    </p>
